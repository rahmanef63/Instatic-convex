 ...
 *
 * Data access is NOT on this context — the built-in sources reach Convex
 * through the injected `@core/loops/dataAdapter` port (filled at server boot),
 * keeping `src/core/loops/` free of server-only imports.
 */
