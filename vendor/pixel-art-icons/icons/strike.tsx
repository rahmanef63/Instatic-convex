...
export function StrikeIcon({ size = 24, color = 'currentColor', className, style }: IconProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
      ...
      style={style}
    >
      <path d="M19 13H5v-2h14v2Z M16 18H8v-2h8v2Z M8 16H6V4h2v12Z M18 16h-2V4h2v12Z"/>
    </svg>
  );
}
